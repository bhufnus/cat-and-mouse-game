...
document.addEventListener("keydown", function (event) {
  if (!gameOver) {
    ...
    // SCRIPT FOR COLLISION DETECTION (decided the game was more fun without it)
    // let mouseBox = mouse.getBoundingClientRect();
    // let playerBox = player.getBoundingClientRect();

    // let overlapping = !(mouseBox.right < playerBox.left ||
    ...
    if (
      playerPosition.vertical === mousePosition.vertical &&
      playerPosition.horizontal === mousePosition.horizontal
    ) {
      endGame();
    }
